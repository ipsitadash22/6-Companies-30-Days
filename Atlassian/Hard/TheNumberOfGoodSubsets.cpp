...
public:
    int numberOfGoodSubsets(vector<int> &nums)
    {
        ...
        if (subsetsContainsOne)
        {
            ...
            // ans = (ans + subsetsContainsOne) % MOD; // adding the count of subsets that contains only 1's. No need to do this because 1 cannot be expressed as the product of distinct prime numbers.
        }
